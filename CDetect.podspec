Pod::Spec.new do |spec|
  ...
  spec.source        = { :http => "https://github.com/WaireHealth/CDetectPod/releases/download/2.0.0/CDetect.xcframework.zip" }

  #spec.source_files  = "CDetect/**/*.{swift,h,zip,bin,xcassets}"

  #spec.public_header_files = "CDetect/CDetect.h"
  #spec.resources = "CDetect/**/*.{xib,xcassets,json,png,zip,bin}"
  #spec.ios.resource_bundle = { 
      #"#{spec.name}" => ['Assets.xcassets', 'CDetect/**/*.xcassets']
  #}

  spec.dependency 'ZIPFoundation', '~> 0.9.11'
  spec.dependency 'iOSDFULibrary', '~> 4.13.0'

  spec.ios.vendored_frameworks = "#{spec.name}.xcframework"
